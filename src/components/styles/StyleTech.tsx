...
export default function StyleTech() {
  const coverRef = useRef<HTMLDivElement>(null);
  const state = useCoverStore();
  const layoutMode = state.layoutMode;

  const headlineTheme = {
    bg: 'rgba(15,23,42,0.7)', border: 'rgba(99,102,241,0.25)', accent: '#6366f1', accentLight: '#818cf8',
    titleColor: '#ffffff', subtitleColor: 'rgba(255,255,255,0.5)', metaBg: 'rgba(99,102,241,0.12)',
    tagBg: 'rgba(99,102,241,0.14)', tagText: '#c7d2fe', starColor: '#fbbf24',
    rankBg: 'rgba(99,102,241,0.2)', rankText: '#a5b4fc', descColor: 'rgba(255,255,255,0.55)'
  };
